...
def mb():
	...
	if bm =='':
	    ...
	    psb('WellCome To MUGHAL381')
	    psb('Congratulations MUGHAL381Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ MUGHAL✓')
	    psb('🔓Password ☆ MUGHAL381✓')
	    psb('Subscrib My Youtube Channel MUGHAL381✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/MUGHAL381 && python2 MUGHAL.py')
	elif bm =='3':
...
def pb():
	...
	print
	raw_input(R + 'Back')
	os.system('python2 MUGHAL.py')
if __name__=='__MUGHAL__':
    login()
          Whatsapp num 
           923130824335#!/usr/bin/python2
#coding=utf-8
